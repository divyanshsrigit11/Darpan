...
namespace Darpan
{
    ...
    {
        private const int SportsCategoryId = 15; // ID for 'Sports' from dbo.NewsCategory
        ...
        private void BindNewsArticles()
        {
            ...
            {
                // Query to fetch news articles for the Sports category
                string query = @"
                    SELECT
                ...
                {
                    cmd.Parameters.AddWithValue("@NewsCategoryId", SportsCategoryId);
