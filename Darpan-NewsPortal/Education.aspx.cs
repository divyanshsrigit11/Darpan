...
namespace Darpan
{
    ...
    {
        private const int EducationCategoryId = 16; // ID for 'Education' from dbo.NewsCategory
        ...
        private void BindNewsArticles()
        {
            ...
            {
                // Query to fetch news articles for the Education category
                string query = @"
                    SELECT
                ...
                {
                    cmd.Parameters.AddWithValue("@NewsCategoryId", EducationCategoryId);
